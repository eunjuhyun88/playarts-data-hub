                ...
                <SidebarMenu>
                  <SidebarMenuItem>
                    ...
                    >
                      ...
                      <span className="font-space">Data Lake</span>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  <SidebarMenuItem>
                    <SidebarMenuButton 
                    ...
                    >
                      ...
                      <span className="font-space">Dataset Studio</span>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  <SidebarMenuItem>
                    <SidebarMenuButton 
                    ...
                    >
                      ...
                      <span className="font-space">Training Jobs</span>
                ...
                <SidebarMenu>
                  ...
                  <SidebarMenuItem>
                    ...
                    >
                      ...
                      <span className="font-space">Command Center</span>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-muted-foreground">
                  {currentView === "explorer" && "All Assets"}
                  {currentView === "studio" && "Builder"}
                  {currentView === "models" && "Pipeline"}
                </span>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/30">
                ...
                <span className="text-xs font-mono text-primary font-medium">HUB ONLINE</span>
              </div>
            </div>
          </header>
